...
static const int MIN_PRIVATESEND_PEER_PROTO_VERSION = 80101;

static const CAmount PRIVATESEND_COLLATERAL         = 0.001 * COIN;
static const CAmount PRIVATESEND_POOL_MAX           = 1499.999 * COIN;
static const int DENOMS_COUNT_MAX                   = 100;

static const int DEFAULT_PRIVATESEND_ROUNDS         = 2;
static const int DEFAULT_PRIVATESEND_AMOUNT         = 1500;
...
{
public:
    /// Is the input associated with this public key? (and there is 1500 CRC - checking if valid masternode)
